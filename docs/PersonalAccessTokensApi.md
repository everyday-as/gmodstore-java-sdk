...
> InlineResponse201 createPersonalAccessToken(newPersonalAccessTokenPayload)
...
import no.everyday.gmodstore_sdk.api.PersonalAccessTokensApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    PersonalAccessTokensApi apiInstance = new PersonalAccessTokensApi(defaultClient);
    NewPersonalAccessTokenPayload newPersonalAccessTokenPayload = new NewPersonalAccessTokenPayload(); // NewPersonalAccessTokenPayload | 
    try {
      InlineResponse201 result = apiInstance.createPersonalAccessToken(newPersonalAccessTokenPayload);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PersonalAccessTokensApi#createPersonalAccessToken");
...
public class Example {
  public static void main(String[] args) {
    ...
    PersonalAccessTokensApi apiInstance = new PersonalAccessTokensApi(defaultClient);
    String personalAccessToken = "personalAccessToken_example"; // String | 
    try {
      DeleteTeamResponse result = apiInstance.deletePersonalAccessToken(personalAccessToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PersonalAccessTokensApi#deletePersonalAccessToken");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling PersonalAccessTokensApi#getPersonalAccessToken");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> Object listPersonalAccessTokens(perPage, cursor)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling PersonalAccessTokensApi#listPersonalAccessTokens");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling PersonalAccessTokensApi#updatePersonalAccessToken");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
