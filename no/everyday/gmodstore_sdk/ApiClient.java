...
import no.everyday.gmodstore_sdk.auth.Authentication;
import no.everyday.gmodstore_sdk.auth.HttpBasicAuth;
import no.everyday.gmodstore_sdk.auth.HttpBearerAuth;
import no.everyday.gmodstore_sdk.auth.ApiKeyAuth;

public class ApiClient {

    private String basePath = "https://api.gmodstore.com/v2";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.4.2/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.gmodstore.com/v2
