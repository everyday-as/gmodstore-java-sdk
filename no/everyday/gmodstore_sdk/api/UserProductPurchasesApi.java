...
public class UserProductPurchasesApi {
    private ApiClient localVarApiClient;

    public UserProductPurchasesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public UserProductPurchasesApi(ApiClient apiClient) {
     ...
     */
    public okhttp3.Call listUserPurchasesCall(String user, String cursor, ProductPurchaseFilter filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v3/users/{user}/purchases"
    ...
    private okhttp3.Call listUserPurchasesValidateBeforeCall(String user, String cursor, ProductPurchaseFilter filter, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'user' is set
        if (user == null) {
            throw new ApiException("Missing the required parameter 'user' when calling listUserPurchases(Async)");
        }
        

        okhttp3.Call localVarCall = listUserPurchasesCall(user, cursor, filter, _callback);
        return localVarCall;
     ...
     */
    public Object listUserPurchases(String user, String cursor, ProductPurchaseFilter filter) throws ApiException {
        ApiResponse<Object> localVarResp = listUserPurchasesWithHttpInfo(user, cursor, filter);
     ...
     */
    public ApiResponse<Object> listUserPurchasesWithHttpInfo(String user, String cursor, ProductPurchaseFilter filter) throws ApiException {
        okhttp3.Call localVarCall = listUserPurchasesValidateBeforeCall(user, cursor, filter, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List all the specified user&#39;s purchases (asynchronously)
     * 
     * @param user  (required)
     * @param cursor The cursor from which to return paginated results starting after (optional)
     * @param filter Filter the results (optional)
     ...
     */
    public okhttp3.Call listUserPurchasesAsync(String user, String cursor, ProductPurchaseFilter filter, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = listUserPurchasesValidateBeforeCall(user, cursor, filter, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
