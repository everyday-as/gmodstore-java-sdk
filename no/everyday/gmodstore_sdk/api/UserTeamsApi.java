...
public class UserTeamsApi {
     ...
     */
    public okhttp3.Call listUserTeamsCall(Long userId, Set<String> with, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listUserTeamsValidateBeforeCall(Long userId, Set<String> with, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listUserTeamsCall(userId, with, _callback);
        return localVarCall;
     ...
     */
    public TeamListResponse listUserTeams(Long userId, Set<String> with) throws ApiException {
        ApiResponse<TeamListResponse> localVarResp = listUserTeamsWithHttpInfo(userId, with);
     ...
     */
    public ApiResponse<TeamListResponse> listUserTeamsWithHttpInfo(Long userId, Set<String> with) throws ApiException {
        okhttp3.Call localVarCall = listUserTeamsValidateBeforeCall(userId, with, null);
     ...
     */
    public okhttp3.Call listUserTeamsAsync(Long userId, Set<String> with, final ApiCallback<TeamListResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listUserTeamsValidateBeforeCall(userId, with, _callback);
        Type localVarReturnType = new TypeToken<TeamListResponse>(){}.getType();
