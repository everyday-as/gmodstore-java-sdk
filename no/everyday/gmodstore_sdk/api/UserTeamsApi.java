...
public class UserTeamsApi {
     ...
     */
    public okhttp3.Call listUserTeamsCall(String user, Integer perPage, String cursor, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v3/users/{user}/teams"
    ...
    private okhttp3.Call listUserTeamsValidateBeforeCall(String user, Integer perPage, String cursor, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'user' is set
        if (user == null) {
            throw new ApiException("Missing the required parameter 'user' when calling listUserTeams(Async)");
        }
        

        okhttp3.Call localVarCall = listUserTeamsCall(user, perPage, cursor, _callback);
        return localVarCall;
     ...
     */
    public Object listUserTeams(String user, Integer perPage, String cursor) throws ApiException {
        ApiResponse<Object> localVarResp = listUserTeamsWithHttpInfo(user, perPage, cursor);
     ...
     */
    public ApiResponse<Object> listUserTeamsWithHttpInfo(String user, Integer perPage, String cursor) throws ApiException {
        okhttp3.Call localVarCall = listUserTeamsValidateBeforeCall(user, perPage, cursor, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List all the specified user&#39;s teams (asynchronously)
     * 
     * @param user  (required)
     * @param perPage  (optional, default to 24)
     * @param cursor The cursor from which to return paginated results starting after (optional)
     ...
     */
    public okhttp3.Call listUserTeamsAsync(String user, Integer perPage, String cursor, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = listUserTeamsValidateBeforeCall(user, perPage, cursor, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
